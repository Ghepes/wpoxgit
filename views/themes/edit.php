...
<form action="" method="POST">
    ...
    <input type="hidden" name="wpoxgit[action]" value="edit-theme">
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td>
                <input class="regular-text" type="text" name="wpoxgit[repository]" value="<?php echo $theme->repository; ?>">
        ...
        <tr>
            ...
            <td>
                <input placeholder="master" type="text" name="wpoxgit[branch]" value="<?php echo $theme->repository->getBranch(); ?>">
            </td>
        </tr>
        <tr>
            <th scope="row">
            ...
            <td>
                <input name="wpoxgit[subdirectory]" type="text" class="regular-text" placeholder="Optional" value="<?php echo $theme->getSubdirectory(); ?>">
        ...
        <tr>
            ...
            <td>
                <label><input type="checkbox" name="wpoxgit[ptd]" <?php echo ($theme->pushToDeploy) ? 'checked' : null; ?>> Push-to-Deploy</label>
            </td>
        </tr>
        </tbody>
    </table>
...
<form action="" method="POST">
    ...
    <input type="hidden" name="wpoxgit[action]" value="unlink-theme">
    <input type="hidden" name="wpoxgit[stylesheet]" value="<?php echo $theme->stylesheet; ?>">
    <input type="submit" class="button button-delete" value="Unlink theme" style="float:right;">
</form>
<a href="?page=wpoxgit-themes">Back to themes</a>
<br><br>
