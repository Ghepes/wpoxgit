...
<form action="" method="POST">
    ...
    <input type="hidden" name="wpoxgit[action]" value="edit-plugin">
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td>
                <input class="regular-text" type="text" name="wpoxgit[repository]" value="<?php echo $plugin->repository; ?>">
        ...
        <tr>
            ...
            <td>
                <input placeholder="master" type="text" name="wpoxgit[branch]" value="<?php echo $plugin->repository->getBranch(); ?>">
            </td>
        </tr>
        <tr>
            <th scope="row">
            ...
            <td>
                <input name="wpoxgit[subdirectory]" type="text" class="regular-text" placeholder="Optional" value="<?php echo $plugin->getSubdirectory(); ?>">
        ...
        <tr>
            ...
            <td>
                <label><input type="checkbox" name="wpoxgit[ptd]" <?php echo ($plugin->pushToDeploy) ? 'checked' : null; ?>> Push-to-Deploy</label>
            </td>
        </tr>
        </tbody>
    </table>
...
<form action="" method="POST">
    ...
    <input type="hidden" name="wpoxgit[action]" value="unlink-plugin">
    <input type="hidden" name="wpoxgit[file]" value="<?php echo $plugin->file; ?>">
    <input type="submit" class="button button-delete" value="Unlink plugin" style="float:right;">
</form>
<a href="?page=wpoxgit-plugins">Back to plugins</a>
<br><br>
