...
use Oxgit\Actions\ThemeUpdateFailed;
...
class ThemeUpgraderSkin extends Theme_Upgrader_Skin
{
    ...
    public function after()
    {
        ...
        if ($this->error === 'up_to_date') {
            $this->error = new WP_Error('wpoxgit_error', 'Theme is up-to-date.');
        }
        ...
        if ( ! is_null($this->error)) {
            do_action('wpoxgit_theme_update_failed', new ThemeUpdateFailed(
