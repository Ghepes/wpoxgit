...
class PluginUpgrader extends Plugin_Upgrader
{
    ...
    public function installPlugin(Plugin $plugin)
    {
        ...
        $zipUrl = apply_filters('wpoxgit_get_zip_url', $this->plugin->repository->getZipUrl(), $plugin);
    ...
    {
        $zipUrl = apply_filters('wpoxgit_get_zip_url', $this->plugin->repository->getZipUrl(), $this->plugin);
