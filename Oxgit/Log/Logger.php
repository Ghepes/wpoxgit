...
use Oxgit\Log\LoggerInterface as PsrLoggerInterface;
use Oxgit\Log\LogLevel as PsrLogLevel;
...
class Logger implements PsrLoggerInterface
{
    ...
    {
        if (get_option('oxgit_logging_enabled') != 1) {
            // Do nothing
            return;
        }

        $reflection = new \ReflectionClass('Oxgit\Log\LogLevel');
