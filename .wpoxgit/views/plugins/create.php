...
<form action="" method="POST">
    ...
    <input type="hidden" name="wpoxgit[action]" value="install-plugin">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="description">Example: wpoxgit/wpoxgit-plugin</p>
                </td>
            </tr>
            <tr>
                <th scope="row">
            ...
            <tr>
                <th scope="row"></th>
                <td>
                    <label><input type="checkbox" name="wpoxgit[dry-run]" <?php if (isset($_POST['wpoxgit']['dry-run'])) echo 'checked'; ?>> <i class="fa fa-link" aria-hidden="true"></i> Link installed plugin</label>
                    <p class="description">Let WP Oxgit take over an already installed plugin</p>
